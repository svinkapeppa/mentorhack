trello_list_needed_text = '''Необходимо вас зарегистрировать! Для этого:
        ...
        Или для демонстрации можете воспользоваться нашей тестовой доской просто нажав на кнопку. Все члены команды должны будут добавиться в доску, ссылка на приглашение: https://trello.com/invite/b/7usXnKsV/2c56a67d8088fe90c4a1362537dab5cd/mentorhack
    '''
